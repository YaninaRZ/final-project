        ...
        <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl text-center">
                    <h2 className="font-style text-[88px] leading-[80px] text-[#68513F] text-center">
                        Products
                    </h2>
                    <p className="font-sans text-[50px] leading-[80px] font-normal text-black-600 text-center">
                        Healthy Skinn, wildly you
                    </p>
