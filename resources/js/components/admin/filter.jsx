...
const filters = [
    {
        ...
        name: 'Category',
        options: [
            { value: 'Face Wash', label: 'Face Wash', checked: false },
            { value: 'Body Wash', label: 'Body Wash', checked: false },
            { value: 'Cleanser', label: 'Cleanser', checked: true },
        ],
    },
];
const activeFilters = [{ value: 'Face Wash', label: 'Face Wash' }];
