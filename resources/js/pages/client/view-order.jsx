...
export default function ViewOrder() {
    ...
    const totalCalculated = order.products.reduce((acc, product) => {
        const price = toPrice(product.price ?? product.sales_price ?? 0);
                ...
                <section aria-labelledby="products-heading" className="mt-8">
                    ...
                    <div className="space-y-24">
                        {order.products.map((product) => {
                            const unitPrice = toPrice(product.price ?? product.sales_price ?? 0);
                            const quantity = product.pivot?.quantity ?? 1;
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="mt-6 sm:col-span-7 sm:mt-0 md:row-end-1">
                                        ...
                                        <p className="mt-1 font-medium text-gray-900">{fmtPrice(unitPrice)}</p>
                                        {product.description && (
                                    ...
                                    <div className="sm:col-span-12 md:col-span-7">
                                        <dl className="grid grid-cols-1 gap-y-8 border-b border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:py-10">
                                            ...
                                            <div>
                                                ...
                                                <dd className="mt-3 text-gray-500">{fmtPrice(total)}</dd>
                                            </div>
                                        </dl>
                    ...
                    <div className="rounded-lg bg-gray-50 px-6 py-6 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-0 lg:py-8">
                        ...
                        <dl className="mt-8 divide-y divide-gray-200 text-sm lg:col-span-7 lg:mt-0 lg:pr-8">
                            <div className="flex items-center justify-between pb-4">
                                ...
                                <dd className="font-medium text-gray-900">{fmtPrice(totalCalculated)}</dd>
                            </div>
                            <div className="flex items-center justify-between pt-4">
                                <dt className="font-medium text-gray-900">Order total</dt>
                                <dd className="font-medium text-indigo-600">{fmtPrice(totalCalculated)}</dd>
                            </div>
                        </dl>
                    </div>
                </section>
